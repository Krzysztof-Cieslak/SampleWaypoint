...
Sample application created by Waypoint template
...
The project is hosted on [GitHub](https://github.com/Krzysztof-Cieslak/SampleWaypoint) where you can report issues, fork
